...
| `memory_headroom` | `float` | `0.95` | Fraction of a Lambda's memory limit that triggers an early emit, flagged `memory_critical`. `0` disables it. Unix only. See [AWS Lambda](/guides/aws-lambda). |
